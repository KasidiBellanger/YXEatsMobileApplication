...
static NSString * const kConsumerKey       = @"1fuAVBcxnRfPcSOhvSiv1g";
static NSString * const kConsumerSecret    = @"H-x3NeKayCgHgiglRFGKtpSp1Cw";
static NSString * const kToken             = @"XW0IGPwJ0St82FfpzuLHDRQXD02IyMUA";
static NSString * const kTokenSecret       = @"7305WJzeO2d9XBzNy6qFLk4hb0s";
